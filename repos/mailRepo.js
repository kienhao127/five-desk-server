...
exports.getNotCloseByUserID = function(mail){
    var sql = `select * from mail where UserID = '${mail.userID}' and StatusId <> '4' and IsDelete = '0' and CompanyId = '${mail.companyID}'`;
    return db.load(sql);
}

//Ticket chua chuyen nhuong
exports.getUnassignedTicket = function(mail){
    var sql = `select * from mail where UserID IS NULL and IsDelete = '0'  and CompanyId = '${mail.companyID}'`;
    return db.load(sql);
}

//Tat ca ticket chua giai quyet (StatusId <> 4)
exports.getAllNotClose = function(mail){
    var sql = `select * from mail where StatusId <> '4' and IsDelete = '0' and CompanyId = '${mail.companyID}'`;
    return db.load(sql);
}

//Ticket moi (StatusId = 1)
exports.getNewSticket = function(mail){
    var sql = `select * from mail where StatusId = '1' and IsDelete = '0' and CompanyId = '${mail.companyID}'`;
    return db.load(sql);
}

//Ticket cho duyet (StatusId = 3)
exports.getPendingSticket = function(mail){
    var sql = `select * from mail where StatusId = '3' and IsDelete = '0' and CompanyId = '${mail.companyID}'`;
    return db.load(sql);
}
...
exports.getDeletedSticket = function(mail){
    var sql = `select * from mail where IsDelete = '1' and CompanyId = '${mail.companyID}'`;
    return db.load(sql);
}